# Guardar en un diccionario los datos de una persona: nombre, apellido
# dni, email, fecha de nacimiento.
...
persona['fechanacimiento'] = input('Ingrese la fecha de nacimiento de la persona: ')
